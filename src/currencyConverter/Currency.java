	...
	public void defaultValues() {
		...
		switch (currency) {	
			case "US Dollar":
				...
				this.exchangeValues.put("INR", 74.54);
				break;
			case "Euro":
				...
				this.exchangeValues.put("INR", 88.22);
				break;
			case "British Pound":
				...
				this.exchangeValues.put("INR", 98.35);
				break;
			case "Swiss Franc":
				...
				this.exchangeValues.put("INR", 81.65);
				break;
			case "Chinese Yuan Renminbi":
				...
				this.exchangeValues.put("INR", 11.28);
				break;
			case "Japanese Yen":
			...
			case "Indian Rupee":
				...
				this.exchangeValues.put("JPY", 1.40);
